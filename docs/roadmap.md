...
| M6: QLearn integration | Pattern database schema, matching, provenance, equivalent rewrites | Backend/window-specific lookup; stale patterns rejected or flagged; ideal equivalence checked; hardware improvement evaluated separately |
